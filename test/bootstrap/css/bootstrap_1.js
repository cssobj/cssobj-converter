module.exports = {
  ...
  '.caret': {
    ...
    marginLeft: '2px',
    verticalAlign: 'middle',
    borderTop: ['4px dashed', '4px solid \\9'],
  ...
  '.dropdown-menu': {
    ...
    border: ['1px solid #ccc', '1px solid rgba(0, 0, 0, .15)'],
    borderRadius: '4px',
  ...
  '.dropup .caret, .navbar-fixed-bottom .dropdown .caret': {
    content: '""',
    borderTop: 0,
    borderBottom: ['4px dashed', '4px solid \\9']
  },
  ...
  '.modal-content': {
    ...
    WebkitBackgroundClip: 'padding-box',
    backgroundClip: 'padding-box',
    border: ['1px solid #999', '1px solid rgba(0, 0, 0, .2)'],
    borderRadius: '6px',
    outline: 0,
  ...
  '.popover': {
    ...
    WebkitBackgroundClip: 'padding-box',
    backgroundClip: 'padding-box',
    border: ['1px solid #ccc', '1px solid rgba(0, 0, 0, .2)'],
    borderRadius: '6px',
  ...
  '.popover.top > .arrow': {
    ...
    left: '50%',
    marginLeft: '-11px',
    borderTopColor: ['#999', 'rgba(0, 0, 0, .25)'],
    borderBottomWidth: 0
  },
  ...
  '.popover.right > .arrow': {
    ...
    left: '-11px',
    marginTop: '-11px',
    borderRightColor: ['#999', 'rgba(0, 0, 0, .25)'],
    borderLeftWidth: 0
  },
  ...
  '.popover.bottom > .arrow': {
    ...
    marginLeft: '-11px',
    borderTopWidth: 0,
    borderBottomColor: ['#999', 'rgba(0, 0, 0, .25)']
  },
  ...
  '.popover.left > .arrow': {
    ...
    marginTop: '-11px',
    borderRightWidth: 0,
    borderLeftColor: ['#999', 'rgba(0, 0, 0, .25)']
  },
